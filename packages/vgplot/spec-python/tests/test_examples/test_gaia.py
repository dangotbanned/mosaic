        ...
        "hconcat": [
                ...
                "vconcat": [
                    {
                        "plot": [
                            {
                                "mark": "raster",
                                "data": {"source": "gaia", "filter_by": ms.ParamRef("$brush")},
                                "x": "u",
                                "y": "v",
                                "fill": "density",
                        ...
                        "xy_domain": "Fixed",
                        "color_scale": ms.ParamRef("$scale_type"),
                        ...
                        "hconcat": [
                            {
                                ...
                                "x_domain": "Fixed",
                                "y_scale": ms.ParamRef("$scale_type"),
                                "y_grid": True,
                                "width": 220,
                                "height": 120,
                                "margin_left": 65,
            ...
            {"hspace": 10},
            {
                "plot": [
                    ...
                    {"select": "intervalXY", "pixel_size": 2, "bind": ms.ParamRef("$brush")},
                ],
                "xy_domain": "Fixed",
                "color_scale": ms.ParamRef("$scale_type"),
                "color_scheme": "viridis",
