"""Support module for `test_peps_692.py`.

Re-implements [vgplot/_generated/encodings.py] in terms of [`Unpack[TypedDict]`](https://peps.python.org/pep-0692/)
...
def col(**kwds: Any) -> Any:
    """Represents the suggestion in [typeddict-unions](https://peps.python.org/pep-0692/#typeddict-unions).
