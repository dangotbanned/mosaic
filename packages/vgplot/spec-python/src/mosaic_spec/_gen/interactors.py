...
PlotInteractor = TypeAliasType('PlotInteractor', Highlight | IntervalX | IntervalXY | IntervalY | NearestX | NearestY | Pan | PanX | PanY | PanZoom | PanZoomX | PanZoomY | Region | Toggle | ToggleColor | ToggleX | ToggleY)
'''A plot interactor entry.'''


__all__ = ("BrushStyles","Highlight","IntervalX","IntervalXY","IntervalY","NearestX","NearestY","Pan","PanX","PanY","PanZoom","PanZoomX","PanZoomY","PlotInteractor","Region","Toggle","ToggleColor","ToggleX","ToggleY",)
