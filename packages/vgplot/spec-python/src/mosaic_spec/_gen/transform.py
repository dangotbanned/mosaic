...
BinInterval = TypeAliasType('BinInterval', L['date','day','hour','millisecond','minute','month','number','second','year'])
...
IntervalTransform = TypeAliasType('IntervalTransform', Days | Hours | Microseconds | Milliseconds | Minutes | Months | Seconds | Years)
'''Date/time interval.'''
ColumnTransform = TypeAliasType('ColumnTransform', Bin | Centroid | CentroidX | CentroidY | Column | DateDay | DateMonth | DateMonthDay | GeoJSON)
'''A data transform that maps one column value to another.'''
FrameValue = TypeAliasType('FrameValue', IntervalTransform | None | float)
class WindowOptions(TypedDict,total=False):
    """Window transform options."""
    exclude: L['CURRENT ROW','GROUP','NO OTHERS','TIES','current row','group','no others','ties']
...
class DenseRank(WindowOptions,total=False,closed=True):
    ...
    dense_rank: Required[None | tuple[()]]
...
class Lag(WindowOptions,total=False,closed=True):
    ...
    lag: Required[ParamRef | bool | float | str | tuple[ParamRef | bool | float | str,ParamRef | bool | float | str,ParamRef | bool | float | str] | tuple[ParamRef | bool | float | str,ParamRef | bool | float | str] | tuple[ParamRef | bool | float | str]]
...
class Lead(WindowOptions,total=False,closed=True):
    ...
    lead: Required[ParamRef | bool | float | str | tuple[ParamRef | bool | float | str,ParamRef | bool | float | str,ParamRef | bool | float | str] | tuple[ParamRef | bool | float | str,ParamRef | bool | float | str] | tuple[ParamRef | bool | float | str]]
...
class NthValue(WindowOptions,total=False,closed=True):
    ...
    nth_value: Required[ParamRef | bool | float | str | tuple[ParamRef | bool | float | str,ParamRef | bool | float | str] | tuple[ParamRef | bool | float | str]]
...
class PercentRank(WindowOptions,total=False,closed=True):
    ...
    percent_rank: Required[None | tuple[()]]
...
class RowNumber(WindowOptions,total=False,closed=True):
    ...
    row_number: Required[None | tuple[()]]
...
class Count(AggregateOptions,total=False,closed=True):
    ...
    count: Required[None | tuple[()] | ParamRef | bool | float | str | tuple[ParamRef | bool | float | str]]
...
WindowTransform = TypeAliasType('WindowTransform', CumeDist | DenseRank | FirstValue | Lag | LastValue | Lead | NTile | NthValue | PercentRank | Rank | RowNumber)
'''A window transform that operates over a sorted domain.'''
AggregateTransform = TypeAliasType('AggregateTransform', Argmax | Argmin | Avg | Count | First | Last | Max | Median | Min | Mode | Product | Quantile | Stddev | StddevPop | Sum | VarPop | Variance)
...
__all__ = ("AggregateOptions","AggregateTransform","Argmax","Argmin","Avg","Bin","BinInterval","Centroid","CentroidX","CentroidY","Column","ColumnTransform","Count","CumeDist","DateDay","DateMonth","DateMonthDay","Days","DenseRank","First","FirstValue","FrameValue","GeoJSON","Hours","IntervalTransform","Lag","Last","LastValue","Lead","Max","Median","Microseconds","Milliseconds","Min","Minutes","Mode","Months","NTile","NthValue","PercentRank","Product","Quantile","Rank","RowNumber","Seconds","Stddev","StddevPop","Sum","Transform","TransformField","VarPop","Variance","WindowOptions","WindowTransform","Years",)
